...
RSpec.describe CommunitiesController, type: :controller do
  ...
  describe "GET #edit" do
    it "returns a success response" do
      community = Community.create! valid_attributes
      get :edit, params: {id: community.to_param}, session: valid_session
      expect(response).to be_success
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Community" do
        expect {
          post :create, params: {community: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {community: invalid_attributes}, session: valid_session
        expect(response).to be_success
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested community" do
        community = Community.create! valid_attributes
        put :update, params: {id: community.to_param, community: new_attributes}, session: valid_session
        community.reload
      ...
      it "redirects to the community" do
        community = Community.create! valid_attributes
        put :update, params: {id: community.to_param, community: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        community = Community.create! valid_attributes
        put :update, params: {id: community.to_param, community: invalid_attributes}, session: valid_session
        expect(response).to be_success
      end
    end
  end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested community" do
      community = Community.create! valid_attributes
      expect {
        delete :destroy, params: {id: community.to_param}, session: valid_session
      }.to change(Community, :count).by(-1)
    end
